...
def genSine(A, f, phi, fs, t):
    ...
    return A * np.cos(2.*np.pi*f*t_arr + phi)

if __name__ == "__main__":
    output = genSine(A=1.0, f = 10.0, phi = 1.0, fs = 50.0, t = 0.1)
    ground_truth = np.array([ 0.54030231, -0.63332387, -0.93171798,  
                              0.05749049,  0.96724906])
